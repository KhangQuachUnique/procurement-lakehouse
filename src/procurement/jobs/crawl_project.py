...
def crawl_project(start: date, end: date, *, page_size: int = 50) -> str:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Crawl closed-day Muasamcong project data")
...
def main() -> None:
    configure_logging()
    args = parse_args()
    crawl_project(args.start_date, args.end_date, page_size=args.page_size)
