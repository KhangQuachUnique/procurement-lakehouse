...
from procurement.jobs.crawl_notify_contractor import _validate_closed_range

TODAY_VN = date(2026, 9, 15)
...
@pytest.mark.parametrize("end", [date(2026, 9, 15), date(2026, 9, 16)])
